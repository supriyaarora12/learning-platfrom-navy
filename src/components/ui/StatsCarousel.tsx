...
export function StatsCarousel({
  ...
  className?: string;
  autoPlayMs?: number;
  /** Tighter padding when nested inside a hero column */
  compact?: boolean;
}) {
  ...
  const shellPad = compact
    ? "relative z-[1] w-full pb-2 pt-6 sm:pb-3 sm:pt-8"
    : "relative z-[1] w-full pb-6 pt-8 sm:pb-8 sm:pt-10";

  return (
    <div
      className={`${shellPad} ${className}`}
